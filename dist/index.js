...
order_1.default.hasOne(payments_1.default, { foreignKey: "orderID", onDelete: "CASCADE" });
payments_1.default.belongsTo(order_1.default, { foreignKey: "orderID" });
...
(0, sockets_1.initChatSocket)(io); // 👈 This line connects your socket logic
